SET IDENTITY_INSERT [EnglishApp].[Permission] ON;

BEGIN TRANSACTION;

IF NOT EXISTS(SELECT *
              FROM [EnglishApp].[Permission]
              WHERE [Name] = 'READ_QUESTION')
    BEGIN
        INSERT INTO [EnglishApp].[Permission]([Id], [Name], [Description])
...
SET IDENTITY_INSERT [EnglishApp].[Permission] OFF;